...
<body>
  <style>
    ...
    * {
    ...
    .gradient-pemisah {
      background-image: linear-gradient(to bottom right, #4C51BF, #702459);
      height: 30px;
    }
  </style>
  <nav class="fixed top-0 z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur text-white text-sm">
    <a href="https://prebuiltui.com">
      ...
      <div class="hidden md:flex items-center gap-8 transition duration-500">
        <a href="home.php" class="hover:text-purple-500 transition">
          Home
        </a>
        <a href="index.php" class="hover:text-purple-500 transition">
          Hitung NPV
        </a>
      ...
      <button id="open-menu" class="md:hidden active:scale-90 transition">
        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-menu-icon lucide-menu">
          <path d="M4 5h16" />
          <path d="M4 12h16" />
          <path d="M4 19h16" />
        </svg>
  ...
  <div class="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-32 bg-black text-white">
    ...
    <div class="flex items-center mt-44">
      <div class="flex -space-x-2 pr-3">
        <img src="./gambar/bidang-perlengkapan.jpg" alt="king-andri" class="size-7 rounded-full border-2 border-white hover:-translate-y-0.5 transition z-1">
        <img src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200" alt="image" class="size-7 rounded-full border-2 border-white hover:-translate-y-0.5 transition z-[2]">
        <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=200&h=200&auto=format&fit=crop" alt="image" class="size-7 rounded-full border-2 border-white hover:-translate-y-0.5 transition z-[3]">
        <img src="https://randomuser.me/api/portraits/men/75.jpg" alt="image" class="size-7 rounded-full border-2 border-white hover:-translate-y-0.5 transition z-[4]">
      </div>
      <div>
        ...
        <p class="text-sm text-gray-300">Used by <span class="font-medium text-white">1</span> users</p>
      </div>
    </div>
    <h1 class="text-5xl leading-[68px] md:text-6xl md:leading-[84px] font-medium max-w-3xl text-center">
      Net Present Value
    </h1>
    <p class="text-base text-center text-slate-200 max-w-lg">Sistem penunjang keputusan untuk menentukan apakah suatu investasi atau keputusan keuangan worth it atau tidak</p>
    <div class="flex items-center gap-4 mt-8">
      <button class="bg-green-600 hover:bg-amber-400 text-white rounded-full px-7 h-11">
        Hitung NPV
      </button>
    </div>
    <img src="./gambar/main-img.jpg"
      class="w-full rounded-[15px] max-w-4xl mt-16 mb-10"
      alt="hero section showcase" />
  </div>
  <div class="w-full gradient-pemisah">
  </div>

  <div class="bg-gray-900 py-24 sm:py-32">
    <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
      <h2 class="text-center text-base/7 font-semibold text-indigo-400">Hitung Cepat</h2>
      <p class="mx-auto mt-2 max-w-lg text-center text-4xl font-semibold tracking-tight text-balance text-white sm:text-5xl">Semua keputusan keuangan mu jadi lebih terukur</p>
        ...
        <div class="relative lg:row-span-2">
          ...
          <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
            <div class="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
              <p class="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">User Friendly</p>
              <p class="mt-2 max-w-lg text-sm/6 text-gray-400 max-lg:text-center">Mudah digunakan, cukup masukkan investasi awal ,bunga dan arus kas pertahun</p>
            </div>
        ...
        <div class="relative max-lg:row-start-1">
          ...
          <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
            <div class="px-8 pt-8 sm:px-10 sm:pt-10">
              <p class="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">Mudah di akses/p>
              <p class="mt-2 max-w-lg text-sm/6 text-gray-400 max-lg:text-center">Kareana berbasis web, mudah di akses di berbagai device berbeda, tidak terikat dengan sistem operasi</p>
            </div>
